...
export default function CanadaVisaPage() {
  const requirements = [
    ...
    'Completed IMM 0008 form (application)',
    ...
    'Biographical page of passport copy',
  ]

  const processSteps = [
    { step: 1, title: 'Prepare Documents', description: 'Gather all required paperwork' },
    { step: 2, title: 'Submit Application', description: 'Submit online or by mail to IRCC' },
    { step: 3, title: 'Biometrics', description: 'Provide biometric data if requested' },
    { step: 4, title: 'Get Approval', description: 'Receive approval and travel document' },
  ]

  const faqs = [
    {
      q: 'How long does Canada visa processing take?',
      a: 'Processing times vary from 4-6 weeks for online applications to 8-12 weeks for paper applications, depending on complexity.',
    },
    {
      q: 'Can I work while waiting for my visa?',
      a: 'You can apply for a work permit while awaiting visa processing. We can help with the work permit application process.',
    },
    {
      q: 'Is medical examination mandatory?',
      a: 'Medical examination is required for certain countries and visa types. IRCC will notify you if it\'s required for your application.',
    },
    {
      q: 'What is the visa fee for Canada?',
      a: 'Visa fees vary by type (visit: CAD $100, study: CAD $150, work: CAD $275). We can provide exact fees for your specific needs.',
    },
  ]
    ...
    <main className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-xl text-muted-foreground mb-6">Visit, study, or work in Canada with our comprehensive support</p>

              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-surface-1 rounded-xl p-4">
                  <Clock className="w-6 h-6 text-green-primary mb-2" />
                  <p className="text-xs text-muted-foreground">Processing</p>
                  <p className="font-bold text-foreground">15-30 days</p>
                </div>
                <div className="bg-surface-1 rounded-xl p-4">
                  <Globe className="w-6 h-6 text-green-primary mb-2" />
                  <p className="text-xs text-muted-foreground">Validity</p>
                  <p className="font-bold text-foreground">6m - 3yr</p>
                </div>
                <div className="bg-surface-1 rounded-xl p-4">
                  <DollarSign className="w-6 h-6 text-green-primary mb-2" />
                  <p className="text-xs text-muted-foreground">Fee</p>
                  <p className="font-bold text-foreground">CAD 100+</p>
                </div>
              </div>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="relative h-96 rounded-2xl overflow-hidden">
              <Image src="/images/dest-canada.jpg" alt="Canada" fill className="object-cover" quality={85} priority />
      ...
      <section className="py-16 bg-gradient-to-r from-green-primary to-green-bright">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Begin Your Canada Journey</h2>
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Apply for your Canada visa today. Our team provides end-to-end support to make your application successful.
          </p>
          <Link href="/contact">
