...
export default function DubaiVisaPage() {
  const requirements = [
    ...
    'Passport-sized photograph (4x6 cm)',
  ...
  const processSteps = [
    { step: 1, title: 'Submit Application', description: 'Fill online form with passport details' },
    { step: 2, title: 'Make Payment', description: 'Pay visa fee via credit/debit card' },
    { step: 3, title: 'Receive Approval', description: 'Get e-visa via email within 48 hours' },
    { step: 4, title: 'Print & Travel', description: 'Print your visa and travel' },
  ]

  const faqs = [
    {
      q: 'How quickly will I receive my Dubai e-visa?',
      a: 'Most Dubai e-visas are approved within 24-48 hours. We also offer same-day processing for an additional fee.',
    },
    {
      q: 'Is the Dubai e-visa valid for multiple entries?',
      a: 'Yes, you can get a 30-day single or 90-day multiple entry e-visa. Choose the one that fits your travel plans.',
    },
    {
      q: 'Do I need travel insurance for Dubai?',
      a: 'Travel insurance is not mandatory but highly recommended for peace of mind during your stay.',
    },
    {
      q: 'Can I extend my Dubai e-visa?',
      a: 'Yes, e-visas can be extended once you arrive in Dubai by visiting the immigration office or through tour operators.',
    },
  ]
    ...
    <main className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-xl text-muted-foreground mb-6">Get your Dubai visa in just 48 hours, completely online</p>

              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-surface-1 rounded-xl p-4">
                  <Clock className="w-6 h-6 text-green-primary mb-2" />
                  <p className="text-xs text-muted-foreground">Processing</p>
                  <p className="font-bold text-foreground">1-2 days</p>
                </div>
                <div className="bg-surface-1 rounded-xl p-4">
                  <Globe className="w-6 h-6 text-green-primary mb-2" />
                  <p className="text-xs text-muted-foreground">Validity</p>
                  <p className="font-bold text-foreground">30-90 days</p>
                </div>
                <div className="bg-surface-1 rounded-xl p-4">
                  <DollarSign className="w-6 h-6 text-green-primary mb-2" />
                  <p className="text-xs text-muted-foreground">Fee</p>
                  <p className="font-bold text-foreground">AED 350-500</p>
                </div>
              </div>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="relative h-96 rounded-2xl overflow-hidden">
              <Image src="/images/dest-dubai.jpg" alt="Dubai" fill className="object-cover" quality={85} priority />
      ...
      <section className="py-16 bg-gradient-to-r from-green-primary to-green-bright">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Get Your Dubai Visa in 48 Hours</h2>
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            The fastest and easiest way to get your Dubai e-visa. Apply online and receive your approval within 2 days.
          </p>
          <Link href="/contact">
